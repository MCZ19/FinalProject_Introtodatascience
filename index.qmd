...
pop_stats <- get_acs(geography= "block group",
                  state= "DC",
                  county = "District of Columbia",
                  geometry= TRUE,
...
demographics <- merge(demographics, pop_stats_clean[, c("GEOID", "population")], by = "GEOID", all.x = TRUE)
...
schools %>%
  ...
  labs(title= paste("Across types of schools, populations tend to have greater",
       ...
       subtitle= paste("Elementary Schools are more segregated by poverty",
                       "level than Middle and High Schools"),
...
schools %>%
  ...
  labs(title= paste("As the percent of students per school who identify as",
                    "Black or African American rises, English proficiency",
                    "rates fall"),
